...
class SKCExporter:
    ...
    def __init__(self, filepath: str,
        ...
        Args:
            ...
            version: SKC file version (13 or 14)
        """
    ...
    def _write_animation(self, action: bpy.types.Action) -> None:
        ...
        for i, frame in enumerate(frame_data):
            ...
            frame_bytes_list.append(struct.pack(
                '<3f 3f f 3f f i',
        ...
        output.write(b''.join(frame_bytes_list))
        ...
        for frame_idx, frame_channels in enumerate(channel_values):
            for channel_data in frame_channels:
                channel_bytes_list.append(struct.pack('<4f', *channel_data))
        output.write(b''.join(channel_bytes_list))
