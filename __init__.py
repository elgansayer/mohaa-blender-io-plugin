...
class EXPORT_OT_skd(Operator, ExportHelper):
    ...
    version: EnumProperty(
        ...
        items=[
            ('6', "Version 6 (Standard)", "Standard format with morph support (MoH:AA/SH/BT)"),
            ('5', "Version 5 (Old)", "Old format without morph targets (Legacy)"),
        ],
        default='6',
    )
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Format", icon='FILE_FOLDER')
...
class EXPORT_OT_skc(Operator, ExportHelper):
    ...
    version: EnumProperty(
        ...
        items=[
            ('14', "Version 14 (Standard)", "Standard format (MoH:AA/SH/BT)"),
            ('13', "Version 13 (Old)", "Old format (Legacy)"),
        ],
        default='14',
    )
